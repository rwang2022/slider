function fromFormatted(timeStr) {
    ...
    var _a = time.split(":"), hoursStr = _a[0], minutesStr = _a[1];
...
function toFormatted(minutesAfterMidnight) {
    ...
    // Format the time
    var timeString = String(formattedHours) + ":" + String(minutes).padStart(2, '0') + meridiem;
    return timeString;
}
...
console.assert(toFormatted(1380) === "11:00PM", "test case 17 failed");
console.assert(toFormatted(1437) === "11:57PM", "test case 17 failed");
